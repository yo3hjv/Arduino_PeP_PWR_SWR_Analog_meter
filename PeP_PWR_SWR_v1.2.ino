...
================================================================================
  Version: 1.2
  What is new: Added PWM for Backlight
================================================================================
*/
...
const byte backlightPin = 11;       // PWM backlight pin
...
const int backlightDutyCycle = 90;  // 30% din 255 (255 * 0.3 ≈ 76.5)



void backlight() {   // put some backlight with PWM 
    analogWrite(backlightPin, backlightDutyCycle); // aplică PWM
}
